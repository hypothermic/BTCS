...
public enum Material {
    ...
    private static Material[] byId; // BTCS: removed assignment
    private static final Map<String, Material> BY_NAME; // BTCS: removed assignment
    ...
    // ------------------- BTCS start: *properly* added forge support instead of the poor support in BTCS+
