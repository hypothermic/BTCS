...
public class CraftEnchantment extends org.bukkit.enchantments.Enchantment
{
  ...
  {
    return this.target.slot.canEnchant(net.minecraft.server.Item.byId[item.getTypeId()]);
  }
  ...
  public static net.minecraft.server.Enchantment getRaw(org.bukkit.enchantments.Enchantment enchantment)
  {
