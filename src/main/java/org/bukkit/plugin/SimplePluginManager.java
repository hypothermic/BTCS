 ...
 */
public class SimplePluginManager implements PluginManager { // BTCS: removed 'final' modifier for ForgePluginManager compatibility
    private final Server server;
    private final Map<Pattern, PluginLoader> fileAssociations = new HashMap<Pattern, PluginLoader>();
    // BTCS start: private --> protected
