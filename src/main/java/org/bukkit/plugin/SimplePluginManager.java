...
public class SimplePluginManager implements PluginManager {
    ...
    protected final List<Plugin> plugins = new ArrayList<Plugin>(); // BTCS: private --> protected
    protected final Map<String, Plugin> lookupNames = new HashMap<String, Plugin>(); // BTCS: private --> protected
