...
public final class SpawnerCreature
{
  private static class ChunkEntry extends EntryBase
  {
    ...
    {
      super(0L); // BTCS: don't know what the key is used for but it seems we can get away with 0L.
      this.spawn = spawn;
    }
  ...
  public static final int spawnEntities(World world, boolean flag, boolean flag1) {
    ...
    ArrayList<EntryBase> b = chunkCoords.entries();
                    ...
                    if (world.findNearbyPlayer(f, f1, f2, 24.0D) == null) {
                      ...
                      if (f6 >= 576.0F) {
                        ...
                        if (entityliving.canSpawn()) {
                          ...
                          world.addEntity(entityliving, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.NATURAL); // BTCS: added org.bukkit.event.entity.
  ...
  private static void a(EntityLiving entityliving, World world, float f, float f1, float f2)
  {
    ...
    if (((entityliving instanceof EntitySpider)) && (world.random.nextInt(100) == 0)) {
      ...
      world.addEntity(entityskeleton, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.JOCKEY);
      ...
      for (int i = 0; i < 2; i++) {
        ...
        world.addEntity(entityocelot, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.NATURAL);
      }
    }
  }
        ...
        for (int j2 = 0; j2 < i1; j2++) {
          ...
          for (int k2 = 0; (!flag) && (k2 < 4); k2++) {
            ...
            if (a(EnumCreatureType.CREATURE, world, j1, l2, k1)) {
              ...
              world.addEntity(entityliving, org.bukkit.event.entity.CreatureSpawnEvent.SpawnReason.CHUNK_GEN);
              a(entityliving, world, f, f1, f2);
              flag = true;
            }
