...
public class ItemFood extends Item {
  ...
  public ItemFood(int i, int j, float f, boolean flag) { super(i);
    this.a = 32;
    this.b = j;
    this.bV = flag;
    this.bU = f;
  ...
  public ItemStack b(ItemStack itemstack, World world, EntityHuman entityhuman) {
    ...
    FoodLevelChangeEvent event = org.bukkit.craftbukkit.event.CraftEventFactory.callFoodLevelChangeEvent(entityhuman, getNutrition() + oldFoodLevel);
