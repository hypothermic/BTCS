...
import org.bukkit.event.inventory.InventoryType; // BTCS
import org.bukkit.event.inventory.InventoryType.SlotType; // BTCS
...
public class NetServerHandler extends NetHandler implements ICommandListener
{
  ...
  public NetServerHandler(MinecraftServer minecraftserver, NetworkManager networkmanager, EntityPlayer entityplayer) { this.minecraftServer = minecraftserver;
  ...
  private static final HashSet<Integer> invalidItems = new HashSet(java.util.Arrays.asList(new Integer[] { Integer.valueOf(8), Integer.valueOf(9), Integer.valueOf(10), Integer.valueOf(11), Integer.valueOf(26), Integer.valueOf(34), Integer.valueOf(36), Integer.valueOf(51), Integer.valueOf(52), Integer.valueOf(55), Integer.valueOf(59), Integer.valueOf(60), Integer.valueOf(63), Integer.valueOf(64), Integer.valueOf(68), Integer.valueOf(71), Integer.valueOf(75), Integer.valueOf(78), Integer.valueOf(83), Integer.valueOf(90), Integer.valueOf(92), Integer.valueOf(93), Integer.valueOf(94), Integer.valueOf(95) }));
  ...
  public void a(Packet14BlockDig packet14blockdig) {
    ...
    if (packet14blockdig.e == 4)
    {
      ...
      boolean flag = worldserver.weirdIsOpCache = worldserver.dimension != 0 || (this.minecraftServer.serverConfigurationManager.isOp(this.player.name)); // BTCS: rm ' ? 1 : 0'
      boolean flag1 = false;
  ...
  public void a(Packet15Place packet15place) {
    ...
    boolean flag1 = worldserver.weirdIsOpCache = worldserver.dimension != 0 || (this.minecraftServer.serverConfigurationManager.isOp(this.player.name)); // BTCS: rm ' ? 1 : 0'
  ...
  public void sendPacket(Packet packet)
  {
    ...
    if ((packet instanceof Packet6SpawnPosition)) {
      ...
      for (String line : org.bukkit.craftbukkit.TextWrapper.wrapText(message)) {
  ...
  public void a(Packet16BlockItemSwitch packet16blockitemswitch)
  {
    ...
    if ((packet16blockitemswitch.itemInHandIndex >= 0) && (packet16blockitemswitch.itemInHandIndex < PlayerInventory.getHotbarSize())) {
      org.bukkit.event.player.PlayerItemHeldEvent event = new org.bukkit.event.player.PlayerItemHeldEvent(getPlayer(), this.player.inventory.itemInHandIndex, packet16blockitemswitch.itemInHandIndex);
      this.server.getPluginManager().callEvent(event);
  ...
  public void a(Packet9Respawn packet9respawn)
  {
    if (this.player.viewingCredits)
    {
      ...
      if (this.player.getBukkitEntity().getBedSpawnLocation() == null) {
        ...
        toLocation = new Location(cworld, chunkcoordinates.x + 0.5D, chunkcoordinates.y, chunkcoordinates.z + 0.5D); // BTCS: rm decl
  ...
  public void a(Packet102WindowClick packet102windowclick) {
    ...
    if ((this.player.activeContainer.windowId == packet102windowclick.a) && (this.player.activeContainer.c(this.player)))
    {
      ...
      if ((packet102windowclick.slot == 0) && ((top instanceof CraftingInventory))) {
        ...
        if (recipe != null) {
          event = new org.bukkit.event.inventory.CraftItemEvent(recipe, inventory, type, packet102windowclick.slot, packet102windowclick.button != 0, packet102windowclick.shift);
        }
      }
      this.server.getPluginManager().callEvent(event);
  ...
  public void a(Packet107SetCreativeSlot packet107setcreativeslot) {
    if (this.player.itemInWorldManager.isCreative()) {
      ...
      InventoryClickEvent event = new InventoryClickEvent(inventory, slot, slot == InventoryType.SlotType.OUTSIDE ? 64537 : packet107setcreativeslot.slot, false, false);
      this.server.getPluginManager().callEvent(event);
      org.bukkit.inventory.ItemStack item = event.getCurrentItem();
  ...
  public void a(Packet130UpdateSign packet130updatesign) {
    ...
    if (worldserver.isLoaded(packet130updatesign.x, packet130updatesign.y, packet130updatesign.z)) {
      ...
      if ((tileentity instanceof TileEntitySign)) {
        int j = packet130updatesign.x; // BTCS: added decl 'int '
