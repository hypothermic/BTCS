...
public abstract class EntityHuman extends EntityLiving
{
  ...
  public HumanEntity getBukkitEntity() { return (HumanEntity)super.getBukkitEntity(); }
  ...
  public void attack(Entity entity) {
    ...
    if (entity.k_()) {
      ...
      if ((i > 0) || (k > 0)) {
        ...
        if (flag1) {
          if (j > 0) {
            entity.b_(-MathHelper.sin(this.yaw * 3.1415927F / 180.0F) * j * 0.5F, 0.1D, MathHelper.cos(this.yaw * 3.1415927F / 180.0F) * j * 0.5F);
            this.motX *= 0.6D;
            this.motZ *= 0.6D;
            setSprinting(false);
          }
