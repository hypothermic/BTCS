...
public abstract class EntityHuman extends EntityLiving {
    ...
    // BTCS start: deprecated because of metadata sensitive
    @Deprecated
    ...
    public void openGui(BaseMod mod, int ID, World world, int x, int y, int z) {
      System.out.println("--- Opening GUI start ---");
      ...
      if (handler != null) {
        ...
        if (container != null) {
          ...
          if (container != null) {
            ...
            System.out.println("> Packet info: " + pkt.toString(true));
            ...
            System.out.println("--- Opening GUI complete ---");
          }
        }
      }
    }
