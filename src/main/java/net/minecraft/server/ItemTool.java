...
public class ItemTool extends Item {
	...
	// BTCS: added class itemtool due to forge industrialcraft2 access violation
  ...
  public ItemTool(int i, int j, EnumToolMaterial enumtoolmaterial, Block[] ablock) { // BTCS: 'protected' --> 'public'
    super(i);
