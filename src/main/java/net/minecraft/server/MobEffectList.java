...
public class MobEffectList
{
  ...
  protected MobEffectList(int i, boolean flag, int j) {
    ...
    PotionEffectType.registerPotionEffectType(new org.bukkit.craftbukkit.potion.CraftPotionEffectType(this));
  }
  ...
  public void tick(EntityLiving entityliving, int i) {
    if (this.id == REGENERATION.id) {
      if (entityliving.getHealth() < entityliving.getMaxHealth()) {
        entityliving.heal(1, org.bukkit.event.entity.EntityRegainHealthEvent.RegainReason.MAGIC_REGEN); // BTCS: added 'org.bukkit.event.entity.'
      }
      ...
      entityliving.heal(6 << i, org.bukkit.event.entity.EntityRegainHealthEvent.RegainReason.MAGIC); // BTCS: added 'org.bukkit.event.entity.'
    }
  }
  ...
  public void applyInstantEffect(EntityLiving entityliving, EntityLiving entityliving1, int i, double d0, EntityPotion potion)
  {
    if (((this.id != HEAL.id) || (entityliving1.aN())) && ((this.id != HARM.id) || (!entityliving1.aN()))) {
      ...
      int j = (int)(d0 * (6 << i) + 0.5D);
      entityliving1.heal(j, org.bukkit.event.entity.EntityRegainHealthEvent.RegainReason.MAGIC); // BTCS: added 'org.bukkit.event.entity.'
    }
  }
