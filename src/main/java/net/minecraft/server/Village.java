...
public class Village
{
  ...
  private List i = new java.util.ArrayList();
  private int j = 0;
  ...
  {
    List list = this.world.a(EntityIronGolem.class, AxisAlignedBB.b(this.center.x - this.size, this.center.y - 4, this.center.z - this.size, this.center.x + this.size, this.center.y + 4, this.center.z + this.size));
    
    this.j = list.size();
  }
  
  private void i() {
    List list = this.world.a(EntityVillager.class, AxisAlignedBB.b(this.center.x - this.size, this.center.y - 4, this.center.z - this.size, this.center.x + this.size, this.center.y + 4, this.center.z + this.size));
  ...
  public boolean a(int i, int j, int k) {
    return this.center.c(i, j, k) < this.size * this.size;
  }
  ...
  public VillageDoor d(int i, int j, int k) {
    if (this.center.c(i, j, k) > this.size * this.size) {
      return null;
    }
    Iterator iterator = this.doors.iterator();
