...
public class WM_ItemDummy extends WM_Item
{
  public WM_ItemDummy(int paramInt)
  {
    super(paramInt);
    this.maxStackSize = 1;
  }
  ...
  public ItemStack a(ItemStack paramItemStack, World paramWorld, EntityHuman paramEntityHuman)
  {
    ...
    if (localMovingObjectPosition.type == EnumMovingObjectType.TILE)
    {
      ...
      WM_EntityDummy localWM_EntityDummy = new WM_EntityDummy(paramWorld, i + 0.5F, j + 1.0F, k + 0.5F);
      localWM_EntityDummy.yaw = paramEntityHuman.yaw;
      paramWorld.addEntity(localWM_EntityDummy);
