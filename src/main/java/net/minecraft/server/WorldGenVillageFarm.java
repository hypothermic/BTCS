  ...
  extends WorldGenVillagePiece
{
  ...
  public WorldGenVillageFarm(int paramInt1, Random paramRandom, StructureBoundingBox paramStructureBoundingBox, int paramInt2) {
    super(paramInt1);
  ...
  public static WorldGenVillageFarm a(List paramList, Random paramRandom, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
  {
    ...
    return new WorldGenVillageFarm(paramInt5, paramRandom, localStructureBoundingBox, paramInt4);
  }
