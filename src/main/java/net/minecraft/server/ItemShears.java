...
public class ItemShears extends Item
{
  ...
  public void a(ItemStack itemstack, EntityLiving entity)
  {
    ...
    if ((entity instanceof IShearable))
    {
      ...
      {
        java.util.ArrayList<ItemStack> drops = target.onSheared(itemstack, entity.world, (int)entity.locX, (int)entity.locY, (int)entity.locZ, EnchantmentManager.getEnchantmentLevel(Enchantment.LOOT_BONUS_BLOCKS.id, itemstack));
  ...
  public boolean onBlockStartBreak(ItemStack itemstack, int X, int Y, int Z, EntityHuman player)
  {
    ...
    if ((Block.byId[id] != null) && ((Block.byId[id] instanceof IShearable)))
    {
      ...
      {
        java.util.ArrayList<ItemStack> drops = target.onSheared(itemstack, player.world, X, Y, Z, EnchantmentManager.getEnchantmentLevel(Enchantment.LOOT_BONUS_BLOCKS.id, itemstack));
