...
public class TileEntityNote extends TileEntity { public byte note = 0;
  ...
  public void play(World world, int i, int j, int k) {
    if (world.getMaterial(i, j + 1, k) == Material.AIR) {
      ...
      NotePlayEvent event = org.bukkit.craftbukkit.event.CraftEventFactory.callNotePlayEvent(this.world, i, j, k, b0, this.note);
