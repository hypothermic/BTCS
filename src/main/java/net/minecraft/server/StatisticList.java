...
public class StatisticList
{
  ...
  private static Statistic[] a(String s, int i) {
    Statistic[] astatistic = new Statistic[Block.byId.length]; // BTCS: 256 --> Block.byId.length
    
    for (int j = 0; j < Block.byId.length; j++) { // BTCS: 256 --> Block.byId.length
