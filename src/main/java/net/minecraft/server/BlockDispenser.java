      ...
      if (itemstack == null) {
        ...
        if (!FMLBukkitHandler.instance().tryDispensingEntity(world, d0, d1, d2, b0, b1, itemstack))
        {
          if (itemstack.id == Item.ARROW.id) {
            ...
            entityarrow.shoot(b0, 0.10000000149011612D, b1, 1.1F, 6.0F);
            ...
            entitypotion.a(b0, 0.10000000149011612D, b1, 1.375F, 3.0F);
            ...
            entitythrownexpbottle.a(b0, 0.10000000149011612D, b1, 1.375F, 3.0F);
