...
public class Block implements net.minecraft.src.Block, ITextureProvider { // BTCS: added implements
    ...
    private String name;
    protected static int[] blockFireSpreadSpeed = new int[byId.length]; // BTCS
    protected static int[] blockFlammability = new int[byId.length]; // BTCS
    
    // BTCS start: for ForgeHooks.java
    public float getHardness(int meta) {
      return this.strength;
    }
    
    // for MinecraftForge.java
