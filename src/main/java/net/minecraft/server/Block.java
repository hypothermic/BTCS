...
public class Block implements net.minecraft.src.Block, forge.ITextureProvider { // BTCS: not sure if Block needs to be implemented
    ...
    protected Block(int i, Material material) {
        ...
        isDefaultTexture = (getTextureFile() != null && getTextureFile().equalsIgnoreCase("/terrain.png")); // BTCS
    }
    ...
    public void a(World world, EntityHuman entityhuman, int i, int j, int k, int l) {
        ...
        if (this.canSilkHarvest(world, (EntityPlayer) entityhuman, i, j, k, l) /*&& EnchantmentHelper.getSilkTouchModifier(entityhuman.inventory)*/) { // BTCS: no EnchantmentHelper ??
        // BTCS end
    ...
    public boolean canSilkHarvest(World world, EntityPlayer player, int x, int y, int z, int metadata)
    {
    	...
    	return this.material.j() && !hasTileEntity(metadata);
    	// BTCS end
    }
