...
public class EntityFireball extends Entity
{
  ...
  public void F_() {
    if ((!this.world.isStatic) && (((this.shooter != null) && (this.shooter.dead)) || (!this.world.isLoaded((int)this.locX, (int)this.locY, (int)this.locZ)))) {
      ...
      for (int j = 0; j < list.size(); j++) {
        ...
        if ((entity1.o_()) && ((!entity1.a_(this.shooter)) || (this.k >= 25))) {
          float f = 0.3F;
      ...
      if (movingobjectposition != null) {
        ...
        if (this.dead) {
          ProjectileHitEvent phe = new ProjectileHitEvent((org.bukkit.entity.Projectile)getBukkitEntity());
  ...
  public void b(NBTTagCompound nbttagcompound) {
    ...
    nbttagcompound.set("Direction", a(new double[] { this.dirX, this.dirY, this.dirZ }));
  }
