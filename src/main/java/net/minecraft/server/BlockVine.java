          ...
          for (int k1 = j - 1; k1 <= j + 1; k1++) {
            if (world.getTypeId(i1, k1, j1) == this.id) {
              ...
              if (l <= 0) {
                ...
                // BTCS start: label moved over to here
                int j1x = world.random.nextInt(6);
                int k1x = Direction.d[j1];
                


                if ((j1x == 1) && (j < 255) && (world.isEmpty(i, j + 1, k))) {
                  if (flag) {
                    return;
                  }
                ...
                else if ((j1x >= 2) && (j1x <= 5) && ((i1 & 1 << k1x) == 0)) {
                  if (flag) {
                    return;
                  }
                  ...
                  if ((l1 != 0) && (Block.byId[l1] != null)) {
                    if ((Block.byId[l1].material.j()) && (Block.byId[l1].b())) {
                      world.setData(i, j, k, i1 | 1 << k1x);
                    }
                  } else {
                    int i2 = k1x + 1 & 0x3;
                    int j2 = k1x + 3 & 0x3;
                    if (((i1 & 1 << i2) != 0) && (d(world.getTypeId(i + Direction.a[k1x] + Direction.a[i2], j, k + Direction.b[k1x] + Direction.b[i2])))) {
                      world.setTypeIdAndData(i + Direction.a[k1x], j, k + Direction.b[k1x], this.id, 1 << i2);
                    } else if (((i1 & 1 << j2) != 0) && (d(world.getTypeId(i + Direction.a[k1] + Direction.a[j2], j, k + Direction.b[k1] + Direction.b[j2])))) {
                      world.setTypeIdAndData(i + Direction.a[k1x], j, k + Direction.b[k1x], this.id, 1 << j2);
                    } else if (((i1 & 1 << i2) != 0) && (world.isEmpty(i + Direction.a[k1x] + Direction.a[i2], j, k + Direction.b[k1x] + Direction.b[i2])) && (d(world.getTypeId(i + Direction.a[i2], j, k + Direction.b[i2])))) {
                      world.setTypeIdAndData(i + Direction.a[k1x] + Direction.a[i2], j, k + Direction.b[k1] + Direction.b[i2], this.id, 1 << (k1 + 2 & 0x3));
                    } else if (((i1 & 1 << j2) != 0) && (world.isEmpty(i + Direction.a[k1x] + Direction.a[j2], j, k + Direction.b[k1x] + Direction.b[j2])) && (d(world.getTypeId(i + Direction.a[j2], j, k + Direction.b[j2])))) {
                      world.setTypeIdAndData(i + Direction.a[k1x] + Direction.a[j2], j, k + Direction.b[k1x] + Direction.b[j2], this.id, 1 << (k1 + 2 & 0x3));
                    } else if (d(world.getTypeId(i + Direction.a[k1x], j + 1, k + Direction.b[k1x]))) {
                      world.setTypeIdAndData(i + Direction.a[k1x], j, k + Direction.b[k1x], this.id, 0);
                    }
                  }
                } else if (j > 1) {
