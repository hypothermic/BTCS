  ...
  protected void a(long paramLong, int paramInt1, int paramInt2, byte[] paramArrayOfByte, double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat1, float paramFloat2, float paramFloat3, int paramInt3, int paramInt4, double paramDouble4) {
    ...
    for (; 
      ...
      if ((i == 0) && (paramInt3 == j) && (paramFloat1 > 1.0F) && (paramInt4 > 0)) {
        a(localRandom.nextLong(), paramInt1, paramInt2, paramArrayOfByte, paramDouble1, paramDouble2, paramDouble3, localRandom.nextFloat() * 0.5F + 0.5F, paramFloat2 - 1.5707964F, paramFloat3 / 3.0F, paramInt3, paramInt4, 1.0D);
        a(localRandom.nextLong(), paramInt1, paramInt2, paramArrayOfByte, paramDouble1, paramDouble2, paramDouble3, localRandom.nextFloat() * 0.5F + 0.5F, paramFloat2 + 1.5707964F, paramFloat3 / 3.0F, paramInt3, paramInt4, 1.0D);
        return;
      }
                    ...
                    if ((d11 > -0.7D) && (d9 * d9 + d11 * d11 + d10 * d10 < 1.0D)) {
                      ...
                      if ((i13 == Block.STONE.id) || (i13 == Block.DIRT.id) || (i13 == Block.GRASS.id)) {
                        if (i12 < 10) {
                          ...
                          if ((i11 != 0) && (paramArrayOfByte[(i10 - 1)] == Block.DIRT.id)) paramArrayOfByte[(i10 - 1)] = this.d.getBiome(i6 + paramInt1 * 16, i9 + paramInt2 * 16).A;
                        }
                      }
                    }
                    i10--;
  ...
  protected void a(World paramWorld, int paramInt1, int paramInt2, int paramInt3, int paramInt4, byte[] paramArrayOfByte)
  {
    ...
    for (int j = 0; j < i; j++) {
      ...
      for (int m = 0; m < k; m++)
      {
        ...
        if (this.c.nextInt(10) == 0) { f3 *= (this.c.nextFloat() * this.c.nextFloat() * 3.0F + 1.0F);
        }
