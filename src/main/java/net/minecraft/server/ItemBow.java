...
public class ItemBow extends Item
{
  ...
  public void a(ItemStack itemstack, World world, EntityHuman entityhuman, int i) {
    if (forge.ForgeHooks.onArrowLoose(itemstack, world, entityhuman, c(itemstack) - i))
    {
      return;
    }
    ...
    if ((flag) || (entityhuman.inventory.d(Item.ARROW.id))) {
      ...
      EntityShootBowEvent event = org.bukkit.craftbukkit.event.CraftEventFactory.callEntityShootBowEvent(entityhuman, itemstack, entityarrow, f);
  ...
  public ItemStack a(ItemStack itemstack, World world, EntityHuman entityhuman) {
    ItemStack stack = forge.ForgeHooks.onArrowNock(itemstack, world, entityhuman);
    if (stack != null)
    {
      return stack;
    }
