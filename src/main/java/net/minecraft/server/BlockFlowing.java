  ...
  extends BlockFluids
{
  ...
  private int c(World world, int i, int j, int k, int l, int i1) {
    ...
    for (int k1 = 0; k1 < 4; k1++) {
      if (((k1 != 0) || (i1 != 1)) && ((k1 != 1) || (i1 != 0)) && ((k1 != 2) || (i1 != 3)) && ((k1 != 3) || (i1 != 2))) {
        ...
        if ((!k(world, l1, j, i2)) && ((world.getMaterial(l1, j, i2) != this.material) || (world.getData(l1, j, i2) != 0))) {
  ...
  {
	int l; // BTCS: fixed things around the next 20> lines.
    for (l = 0; l < 4; l++) {
      this.c[l] = 1000;
      int i1 = i;
      int j1 = k;
      ...
      if ((!k(world, i1, j, j1)) && ((world.getMaterial(i1, j, j1) != this.material) || (world.getData(i1, j, j1) != 0))) {
        if (!k(world, i1, j - 1, j1)) {
          this.c[l] = 0;
        } else {
          this.c[l] = c(world, i1, j, j1, 1, l);
        }
      }
    }
    ...
    // BTCS: fixed more things in next 11 lines.
    int i1;
    for (i1 = 1; i1 < 4; i1++) {
      if (this.c[i1] < l) {
        l = this.c[i1];
