...
public class EntityPlayer extends EntityHuman implements ICrafting
{
  ...
  public double d;
  public double e;
  public List chunkCoordIntPairQueue = new java.util.LinkedList();
  ...
  public EntityPlayer(MinecraftServer minecraftserver, World world, String s, ItemInWorldManager iteminworldmanager) { super(world);
  ...
  public void a(boolean flag) {
    ...
    if ((getHealth() == this.cf) && (this.cg == this.foodData.a())) { if ((this.foodData.c() == 0.0F) == this.ch) {}
    } else { this.netServerHandler.sendPacket(new Packet8UpdateHealth(getHealth(), this.foodData.a(), this.foodData.c()));
      this.cf = getHealth();
