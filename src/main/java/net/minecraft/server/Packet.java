...
public abstract class Packet
{
  ...
  private static Map a = new java.util.HashMap();
  private static Set b = new java.util.HashSet();
  private static Set c = new java.util.HashSet();
  ...
  protected NBTTagCompound c(DataInputStream datainputstream) throws IOException {
    ...
    return NBTCompressedStreamTools.a(abyte, false); // BTCS: added 2nd arg
  }
  ...
  protected void a(NBTTagCompound nbttagcompound, DataOutputStream dataoutputstream) throws IOException
  {
    if (nbttagcompound == null) {
      ...
      byte[] abyte = NBTCompressedStreamTools.a(nbttagcompound, false); // BTCS: added 2nd arg
