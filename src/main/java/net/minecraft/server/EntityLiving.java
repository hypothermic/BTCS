...
public abstract class EntityLiving extends Entity implements net.minecraft.src.EntityLiving
{
  ...
  public void F_() {
    ...
    {
    	float f4; // BTCS: moved decl outside for loop
      ...
      float f5; // BTCS: moved decl outside for loop
  ...
  public boolean damageEntity(DamageSource damagesource, int i) {
    ...
    if (flag) {
      ...
      if (entity != null) {
        ...
        double d1; // BTCS: moved decl outside for loop
  ...
  protected void a(float f) {
    ...
    if (i > 0)
    {
      ...
      int j = this.world.getTypeId(MathHelper.floor(this.locX), MathHelper.floor(this.locY - 0.20000000298023224D - this.height), MathHelper.floor(this.locZ));
  ...
  public void e() {
    ...
    if (this.aN > 0) {
      ...
      double d3; // BTCS: moved decl outside for loop
  ...
  {
	  float f3; // BTCS: moved decl outside for loop
