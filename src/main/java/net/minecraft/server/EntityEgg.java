...
public class EntityEgg extends EntityProjectile
{
  ...
  {
    boolean hatching = ((movingobjectposition.entity == null) || (!movingobjectposition.entity.damageEntity(DamageSource.projectile(this, this.shooter), 0))) || ((!this.world.isStatic) && (this.random.nextInt(8) == 0));
