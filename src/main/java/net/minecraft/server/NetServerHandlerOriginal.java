...
public class NetServerHandlerOriginal extends NetHandler implements ICommandListener {

    public static Logger logger = Logger.getLogger("Minecraft");
    public NetworkManager networkManager;
    public boolean disconnected = false;
    public MinecraftServer minecraftServer; // BTCS: protected --> public
    ...
    public NetServerHandlerOriginal(MinecraftServer minecraftserver, NetworkManager networkmanager, EntityPlayer entityplayer) {
        this.minecraftServer = minecraftserver;
        this.networkManager = networkmanager;
        networkmanager.a((NetHandler) this);
        this.player = entityplayer;
        //::: COMMENT BECAUSE OF NAME CHANGE TO NetServerHandlerOriginal TODO ::: //entityplayer.netServerHandler = this;
    ...
    // BTCS start: for PacketHandlerServer.java (Forge)
