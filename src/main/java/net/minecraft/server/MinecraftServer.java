...
public class MinecraftServer implements Runnable, ICommandListener, IMinecraftServer {
    ...
    /*private void a(Convertable convertable, String s, long i, WorldType worldtype) {
        ...
        for (Integer id : DimensionManager.getIDs())
        {
            ...
            world.(new WorldManager(this, world));
    ...
    private void a(Convertable convertable, String s, long i, WorldType worldtype) {
        ...
        // BTCS: do not initialize DimensionManager.
        
        System.out.println("BTCS: Retrieving dimensions...");
    ...
    public EntityTracker getEntityTracker(int par1) {
    	return getWorldManager(par1).tracker;
    }
