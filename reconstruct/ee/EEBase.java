...
public class EEBase
{
  ...
  private static void helmetCheck(EntityHuman var0)
  {
    if ((hasRedHelmet(var0)) && (getPlayerArmorOffensive(var0)))
    {
      ...
      float var11 = MathHelper.cos(-var3 * 0.01745329F - 3.1415927F);
      float var12 = MathHelper.sin(-var3 * 0.01745329F - 3.1415927F);
      ...
      if (var21.type == EnumMovingObjectType.TILE)
      {
        ...
        int var23 = var21.c;
        int var24 = var21.d;
        var0.world.strikeLightning(new net.minecraft.server.EntityWeatherLighting(var0.world, var22, var23, var24));
      }
    }
  }
  ...
  {
    int var1 = 0;
    // BTCS start: not sure if the decompiler messed this up or not, this is my attempt at fixing it.
    /*for (Integer[] var2 = { Integer.valueOf(var0.x), Integer.valueOf(var0.y), Integer.valueOf(var0.z) }; pedestalCoords.get(Integer.valueOf(var1)) != null; var1++) {}
    pedestalCoords.put(Integer.valueOf(var1), var2);*/
    for (Integer[] var2 = { Integer.valueOf(var0.x), Integer.valueOf(var0.y), Integer.valueOf(var0.z) }; 
    pedestalCoords.get(Integer.valueOf(var1)) != null; var1++) {
    	pedestalCoords.put(Integer.valueOf(var1), var2);
    }
    // BTCS end
