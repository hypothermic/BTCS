...
public class EEMaps
{
  ...
  {
	int var1;
    for (var1 = 0; modBlacklist.get(Integer.valueOf(var1)) != null; var1++) {}
    modBlacklist.put(Integer.valueOf(var1), var0);
  }
  
  public static boolean isLeaf(int var0)
  {
    return leafBlockRegistry.containsValue(Integer.valueOf(var0));
  }
  ...
  {
	  int var1;
    for (var1 = 0; leafBlockRegistry.get(Integer.valueOf(var1)) != null; var1++) {}
    leafBlockRegistry.put(Integer.valueOf(var1), Integer.valueOf(var0));
  }
  
  public static boolean isWood(int var0)
  {
    return woodBlockRegistry.containsValue(Integer.valueOf(var0));
  }
  ...
  {
	  int var1;
    for (var1 = 0; woodBlockRegistry.get(Integer.valueOf(var1)) != null; var1++) {}
    woodBlockRegistry.put(Integer.valueOf(var1), Integer.valueOf(var0));
  }
  ...
  {
    return chestItems.get(Integer.valueOf(var0)) == null ? false : ((Boolean)((HashMap)chestItems.get(Integer.valueOf(var0))).get(Integer.valueOf(var1))).booleanValue();
  }
  ...
  private static void addChestItem(int var0, int var1)
  {
    ...
    if (chestItems.get(Integer.valueOf(var0)) != null)
    {
      var2 = (HashMap)chestItems.get(Integer.valueOf(var0));
    }
    
    var2.put(Integer.valueOf(var1), Boolean.valueOf(true));
    chestItems.put(Integer.valueOf(var0), var2);
  }
  ...
  {
    return chargedItems.containsValue(Integer.valueOf(var0));
  }
  ...
  {
	  int var1;
    for (var1 = 0; chargedItems.get(Integer.valueOf(var1)) != null; var1++) {}
    chargedItems.put(Integer.valueOf(var1), Integer.valueOf(var0));
  }
  ...
  {
    return pedestalItems.get(Integer.valueOf(var0)) == null ? false : ((Boolean)((HashMap)pedestalItems.get(Integer.valueOf(var0))).get(Integer.valueOf(var1))).booleanValue();
  }
  ...
  private static void addPedestalItem(int var0, int var1)
  {
    ...
    if (pedestalItems.get(Integer.valueOf(var0)) != null)
    {
      var2 = (HashMap)pedestalItems.get(Integer.valueOf(var0));
    }
    
    var2.put(Integer.valueOf(var1), Boolean.valueOf(true));
    pedestalItems.put(Integer.valueOf(var0), var2);
  }
  
  public static boolean isModItem(int var0)
  {
    return modItems.containsValue(Integer.valueOf(var0));
  }
  ...
  {
	  int var1;
    for (var1 = 0; modItems.get(Integer.valueOf(var1)) != null; var1++) {}
    modItems.put(Integer.valueOf(var1), Integer.valueOf(var0));
  }
  
  public static void addDurationEffectItem(int var0)
  {
    durationEffectItems.put(Integer.valueOf(var0), Boolean.valueOf(true));
  }
  
  public static boolean hasDurationEffect(Item var0)
  {
    return durationEffectItems.get(Integer.valueOf(var0.id)) == null ? false : ((Boolean)durationEffectItems.get(Integer.valueOf(var0.id))).booleanValue();
  }
  ...
  {
    return fuelItemRegistry.get(Integer.valueOf(var0)) == null ? false : ((HashMap)fuelItemRegistry.get(Integer.valueOf(var0))).containsValue(Integer.valueOf(var1));
  }
  ...
  public static void addFuelItem(int var0, int var1)
  {
    ...
    if (fuelItemRegistry.get(Integer.valueOf(var0)) != null)
    {
      var2 = (HashMap)fuelItemRegistry.get(Integer.valueOf(var0));
    }
    
    int var3;
    for (var3 = 0; var2.get(Integer.valueOf(var3)) != null; var3++) {}
    var2.put(Integer.valueOf(var3), Integer.valueOf(var1));
    fuelItemRegistry.put(Integer.valueOf(var0), var2);
  }
  
  public static boolean isOreBlock(int var0)
  {
    return oreBlockRegistry.containsValue(Integer.valueOf(var0));
  }
  ...
  {
	  int var1;
    for (var1 = 0; oreBlockRegistry.get(Integer.valueOf(var1)) != null; var1++) {}
    oreBlockRegistry.put(Integer.valueOf(var1), Integer.valueOf(var0));
  }
  ...
  public static void addEMC(int var0, int var1, int var2)
  {
    if (var2 == 0)
    {
      System.out.println("Error: Alchemical Value of 0 being added to hashmap for item index " + var0 + " of meta " + var1);
    }
  ...
  {
    return metaMappings.get(Integer.valueOf(var0)) == null ? 0 : ((Integer)metaMappings.get(Integer.valueOf(var0))).intValue();
  }
  
  public static void addMeta(int var0, int var1)
  {
    metaMappings.put(Integer.valueOf(var0), Integer.valueOf(var1));
  }
  
  public static boolean isFlyingItem(int var0)
  {
    return flyingItems.containsValue(Integer.valueOf(var0));
  }
  ...
  {
	  int var1;
    for (var1 = 0; flyingItems.get(Integer.valueOf(var1)) != null; var1++) {}
    flyingItems.put(Integer.valueOf(var1), Integer.valueOf(var0));
  }
  
  public static boolean isFireImmuneItem(int var0)
  {
    return fireImmuneItems.containsValue(Integer.valueOf(var0));
  }
  ...
  {
	  int var1;
    for (var1 = 0; fireImmuneItems.get(Integer.valueOf(var1)) != null; var1++) {}
    fireImmuneItems.put(Integer.valueOf(var1), Integer.valueOf(var0));
  }
  
  public static boolean isFireImmuneArmor(int var0)
  {
    return fireImmuneArmors.containsValue(Integer.valueOf(var0));
  }
  ...
  {
	  int var1;
    for (var1 = 0; fireImmuneArmors.get(Integer.valueOf(var1)) != null; var1++) {}
    fireImmuneArmors.put(Integer.valueOf(var1), Integer.valueOf(var0));
  }
  
  public static EEProps InitProps(EEProps var0)
  {
	  // BTCS TODO: move to BTCS config file
  ...
  public static void InitAlchemicalValues()
  {
    ...
    addEMC(Block.SAND.id, getEMC(Block.DIRT.id));
    addEMC(Block.GRASS.id, getEMC(Block.DIRT.id));
    ...
    addEMC(Block.SANDSTONE.id, getEMC(Block.SAND.id) * 4);
    addEMC(Block.STEP.id, 1, getEMC(Block.SANDSTONE.id) / 2);
    addEMC(Block.GLASS.id, getEMC(Block.SAND.id));
    ...
    addEMC(Item.ARROW.id, (getEMC(Item.STICK.id) + getEMC(Item.FLINT.id) + getEMC(Item.FEATHER.id)) / 4);
    addEMC(Block.COBBLESTONE.id, 1);
    addEMC(Block.FURNACE.id, getEMC(Block.COBBLESTONE.id) * 8);
    addEMC(Block.STEP.id, 3, getEMC(Block.COBBLESTONE.id));
    addEMC(Block.COBBLESTONE_STAIRS.id, getEMC(Block.COBBLESTONE.id) * 6 / 4);
    addEMC(Block.LEVER.id, getEMC(Block.COBBLESTONE.id) + getEMC(Item.STICK.id));
    addEMC(Block.NETHERRACK.id, getEMC(Block.COBBLESTONE.id));
    addEMC(Block.STONE.id, getEMC(Block.COBBLESTONE.id));
    addEMC(Block.WHITESTONE.id, getEMC(Block.NETHERRACK.id));
    addEMC(Block.STONE_BUTTON.id, getEMC(Block.STONE.id) * 2);
    addEMC(Block.STONE_PLATE.id, getEMC(Block.STONE.id) * 2);
    addEMC(Block.STEP.id, 0, getEMC(Block.STONE.id));
    
    for (var0 = 0; var0 < 4; var0++)
    {
      addEMC(Block.SMOOTH_BRICK.id, var0, getEMC(Block.STONE.id));
    }
    
    addEMC(Block.STEP.id, 5, getEMC(Block.SMOOTH_BRICK.id));
    addEMC(Block.STONE_STAIRS.id, getEMC(Block.SMOOTH_BRICK.id) * 6 / 4);
    addEMC(Item.STONE_SPADE.id, getEMC(Block.COBBLESTONE.id) + getEMC(Item.STICK.id) * 2);
    addEMC(Item.STONE_SWORD.id, getEMC(Block.COBBLESTONE.id) * 2 + getEMC(Item.STICK.id));
    addEMC(Item.STONE_HOE.id, getEMC(Block.COBBLESTONE.id) * 2 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.STONE_PICKAXE.id, getEMC(Block.COBBLESTONE.id) * 3 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.STONE_AXE.id, getEMC(Block.COBBLESTONE.id) * 3 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.STRING.id, 12);
    addEMC(Item.BOW.id, getEMC(Item.STICK.id) * 3 + getEMC(Item.STRING.id) * 3);
    addEMC(Item.SLIME_BALL.id, 24);
    addEMC(Block.WEB.id, (getEMC(Item.STRING.id) * 2 + getEMC(Item.SLIME_BALL.id)) / 4);
    addEMC(Block.MOSSY_COBBLESTONE.id, getEMC(Block.COBBLESTONE.id) + getEMC(Item.SEEDS.id) + getEMC(Item.SLIME_BALL.id) * 6);
    
    for (var0 = 0; var0 < 16; var0++)
    {
      addEMC(Block.WOOL.id, var0, getEMC(Item.STRING.id) * 4);
    }
    
    addEMC(Item.BED.id, getEMC(Block.WOOL.id) * 3 + getEMC(Block.WOOD.id * 3));
    addEMC(Item.PAINTING.id, getEMC(Block.WOOL.id) + getEMC(Item.STICK.id) * 8);
    ...
    addEMC(Block.BOOKSHELF.id, getEMC(Item.BOOK.id) * 3 + getEMC(Block.WOOD.id) * 6);
    addEMC(Item.WHEAT.id, 24);
    addEMC(Item.BREAD.id, getEMC(Item.WHEAT.id) * 3);
    addEMC(Item.COOKIE.id, (getEMC(Item.WHEAT.id) * 2 + getEMC(Item.INK_SACK.id, 3)) / 8);
    ...
    addEMC(Item.LEATHER_BOOTS.id, getEMC(Item.LEATHER.id) * 4);
    addEMC(Item.LEATHER_HELMET.id, getEMC(Item.LEATHER.id) * 5);
    addEMC(Item.LEATHER_LEGGINGS.id, getEMC(Item.LEATHER.id) * 7);
    addEMC(Item.LEATHER_CHESTPLATE.id, getEMC(Item.LEATHER.id) * 8);
    ...
    addEMC(Item.MAGMA_CREAM.id, getEMC(Item.BLAZE_POWDER.id) + getEMC(Item.SLIME_BALL.id));
    addEMC(Block.BREWING_STAND.id, getEMC(Item.BLAZE_ROD.id) + getEMC(Block.COBBLESTONE.id) * 3);
    ...
    addEMC(Item.RAW_BEEF.id, getEMC(Item.PORK.id));
    addEMC(Item.RAW_CHICKEN.id, getEMC(Item.PORK.id));
    addEMC(Item.RAW_FISH.id, getEMC(Item.PORK.id));
    addEMC(Item.GRILLED_PORK.id, getEMC(Item.PORK.id));
    addEMC(Item.COOKED_BEEF.id, getEMC(Item.RAW_BEEF.id));
    addEMC(Item.COOKED_CHICKEN.id, getEMC(Item.RAW_CHICKEN.id));
    addEMC(Item.COOKED_FISH.id, getEMC(Item.RAW_FISH.id));
    ...
    addEMC(Block.DISPENSER.id, getEMC(Item.BOW.id) + getEMC(Item.REDSTONE.id) + getEMC(Block.COBBLESTONE.id) * 7);
    addEMC(Block.NOTE_BLOCK.id, getEMC(Block.WOOD.id) * 8 + getEMC(Item.REDSTONE.id));
    addEMC(Block.REDSTONE_TORCH_ON.id, getEMC(Item.STICK.id) + getEMC(Item.REDSTONE.id));
    addEMC(Item.DIODE.id, getEMC(Block.STONE.id) * 3 + getEMC(Block.REDSTONE_TORCH_ON.id) * 2 + getEMC(Item.REDSTONE.id));
    ...
    addEMC(Block.TORCH.id, (getEMC(Item.COAL.id, 1) + getEMC(Item.STICK.id)) / 4);
    addEMC(Item.GLOWSTONE_DUST.id, getEMC(Item.REDSTONE.id) * 6);
    addEMC(Block.GLOWSTONE.id, getEMC(Item.GLOWSTONE_DUST.id) * 4);
    addEMC(Block.SOUL_SAND.id, (getEMC(Item.GLOWSTONE_DUST.id) + getEMC(Block.SAND.id) * 8) / 8);
    addEMC(Block.REDSTONE_LAMP_OFF.id, getEMC(Block.GLOWSTONE.id) + getEMC(Item.REDSTONE.id) * 4);
    addEMC(Block.TNT.id, getEMC(Item.SULPHUR.id) * 5 + getEMC(Block.SAND.id) * 4);
    ...
    addEMC(Item.FLINT_AND_STEEL.id, getEMC(Item.FLINT.id) + getEMC(Item.IRON_INGOT.id));
    addEMC(Item.IRON_SPADE.id, getEMC(Item.IRON_INGOT.id) + getEMC(Item.STICK.id) * 2);
    addEMC(Item.IRON_SWORD.id, getEMC(Item.IRON_INGOT.id) * 2 + getEMC(Item.STICK.id));
    addEMC(Item.IRON_HOE.id, getEMC(Item.IRON_INGOT.id) * 2 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.IRON_PICKAXE.id, getEMC(Item.IRON_INGOT.id) * 3 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.IRON_AXE.id, getEMC(Item.IRON_INGOT.id) * 3 + getEMC(Item.STICK.id) * 2);
    addEMC(Block.PISTON.id, getEMC(Item.REDSTONE.id) + getEMC(Item.IRON_INGOT.id) + getEMC(Block.WOOD.id) * 3 + getEMC(Block.COBBLESTONE.id) * 4);
    addEMC(Block.PISTON_STICKY.id, getEMC(Block.PISTON.id) + getEMC(Item.SLIME_BALL.id));
    addEMC(Block.RAILS.id, getEMC(Item.IRON_INGOT.id) * 6 / 16);
    addEMC(Block.DETECTOR_RAIL.id, getEMC(Item.IRON_INGOT.id));
    addEMC(Item.COMPASS.id, getEMC(Item.REDSTONE.id) + getEMC(Item.IRON_INGOT.id) * 4);
    addEMC(Item.MAP.id, getEMC(Item.COMPASS.id) + getEMC(Item.PAPER.id) * 8);
    addEMC(Block.IRON_FENCE.id, getEMC(Item.IRON_INGOT.id) * 6 / 16);
    addEMC(Item.IRON_BOOTS.id, getEMC(Item.IRON_INGOT.id) * 4);
    addEMC(Item.IRON_HELMET.id, getEMC(Item.IRON_INGOT.id) * 5);
    addEMC(Item.IRON_LEGGINGS.id, getEMC(Item.IRON_INGOT.id) * 7);
    addEMC(Item.IRON_CHESTPLATE.id, getEMC(Item.IRON_INGOT.id) * 8);
    addEMC(Item.IRON_DOOR.id, getEMC(Item.IRON_INGOT.id) * 6);
    addEMC(Block.IRON_BLOCK.id, getEMC(Item.IRON_INGOT.id) * 9);
    addEMC(Item.MINECART.id, getEMC(Item.IRON_INGOT.id) * 5);
    ...
    addEMC(Item.BUCKET.id, getEMC(Item.IRON_INGOT.id) * 3);
    ...
    addEMC(Item.LAVA_BUCKET.id, getEMC(Item.BUCKET.id) + getEMC(Item.REDSTONE.id));
    addEMC(Block.OBSIDIAN.id, getEMC(Item.REDSTONE.id));
    addEMC(Item.CAKE.id, getEMC(Item.MILK_BUCKET.id) * 3 - getEMC(Item.BUCKET.id) * 3 + getEMC(Item.SUGAR.id) * 2 + getEMC(Item.WHEAT.id) * 3 + getEMC(Item.EGG.id));
    ...
    addEMC(Block.GOLDEN_RAIL.id, getEMC(Item.GOLD_INGOT.id));
    addEMC(Item.GOLD_SPADE.id, getEMC(Item.GOLD_INGOT.id) + getEMC(Item.STICK.id) * 2);
    addEMC(Item.GOLD_SWORD.id, getEMC(Item.GOLD_INGOT.id) * 2 + getEMC(Item.STICK.id));
    addEMC(Item.GOLD_HOE.id, getEMC(Item.GOLD_INGOT.id) * 2 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.GOLD_PICKAXE.id, getEMC(Item.GOLD_INGOT.id) * 3 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.GOLD_AXE.id, getEMC(Item.GOLD_INGOT.id) * 3 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.WATCH.id, getEMC(Item.GOLD_INGOT.id) * 4 + getEMC(Item.REDSTONE.id));
    addEMC(Item.GOLD_BOOTS.id, getEMC(Item.GOLD_INGOT.id) * 4);
    addEMC(Item.GOLD_HELMET.id, getEMC(Item.GOLD_INGOT.id) * 5);
    addEMC(Item.GOLD_LEGGINGS.id, getEMC(Item.GOLD_INGOT.id) * 7);
    addEMC(Item.GOLD_CHESTPLATE.id, getEMC(Item.GOLD_INGOT.id) * 8);
    addEMC(Block.GOLD_BLOCK.id, getEMC(Item.GOLD_INGOT.id) * 9);
    addEMC(Item.DIAMOND.id, 8192);
    addEMC(Item.GHAST_TEAR.id, getEMC(Item.DIAMOND.id) / 2);
    addEMC(Block.JUKEBOX.id, getEMC(Item.DIAMOND.id) + getEMC(Block.WOOD.id) * 8);
    addEMC(Block.ENCHANTMENT_TABLE.id, getEMC(Item.DIAMOND.id) * 2 + getEMC(Block.OBSIDIAN.id) * 4 + getEMC(Item.BOOK.id));
    addEMC(Item.DIAMOND_SPADE.id, getEMC(Item.DIAMOND.id) + getEMC(Item.STICK.id) * 2);
    addEMC(Item.DIAMOND_SWORD.id, getEMC(Item.DIAMOND.id) * 2 + getEMC(Item.STICK.id));
    addEMC(Item.DIAMOND_HOE.id, getEMC(Item.DIAMOND.id) * 2 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.DIAMOND_PICKAXE.id, getEMC(Item.DIAMOND.id) * 3 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.DIAMOND_AXE.id, getEMC(Item.DIAMOND.id) * 3 + getEMC(Item.STICK.id) * 2);
    addEMC(Item.DIAMOND_BOOTS.id, getEMC(Item.DIAMOND.id) * 4);
    addEMC(Item.DIAMOND_HELMET.id, getEMC(Item.DIAMOND.id) * 5);
    addEMC(Item.DIAMOND_LEGGINGS.id, getEMC(Item.DIAMOND.id) * 7);
    addEMC(Item.DIAMOND_CHESTPLATE.id, getEMC(Item.DIAMOND.id) * 8);
    addEMC(Block.DIAMOND_BLOCK.id, getEMC(Item.DIAMOND.id) * 9);
    addEMC(EEItem.kleinStar1.id, getEMC(Item.DIAMOND.id) + getEMC(EEItem.mobiusFuel.id) * 8);
    ...
    addEMC(Item.SHEARS.id, getEMC(Item.IRON_INGOT.id) * 2);
    addEMC(Item.SADDLE.id, getEMC(Item.LEATHER.id) * 3);
    addEMC(Block.DRAGON_EGG.id, getEMC(EEItem.darkMatter.id));
    addEMC(Item.RECORD_11.id, getEMC(Item.GOLD_INGOT.id));
