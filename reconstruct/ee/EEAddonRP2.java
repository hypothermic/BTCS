...
public class EEAddonRP2
{
  ...
  public static void initBase()
  {
    try
    {
      rp2Resources = (Item)Class.forName("net.minecraft.server.RedPowerBase").getField("itemResource").get(null);
      rp2HandsawIron = (Item)Class.forName("net.minecraft.server.RedPowerBase").getField("itemHandsawIron").get(null);
      rp2HandsawDiamond = (Item)Class.forName("net.minecraft.server.RedPowerBase").getField("itemHandsawDiamond").get(null);
      rp2IndigoDye = (Item)Class.forName("net.minecraft.server.RedPowerBase").getField("itemDyeIndigo").get(null);
      ...
      net.minecraft.server.ModLoader.getLogger().fine("[EE2] Loaded EE2-RP2 Core Addon");
    }
    catch (Exception var1)
    {
      rp2BaseIsInstalled = false;
      net.minecraft.server.ModLoader.getLogger().warning("[EE2] Could not load EE2-RP2 Core Addon");
  ...
  public static void initWorld()
  {
    try
    {
      rp2Ores = (Block)Class.forName("net.minecraft.server.RedPowerWorld").getField("blockOres").get(null);
      rp2Leaves = (Block)Class.forName("net.minecraft.server.RedPowerWorld").getField("blockLeaves").get(null);
      rp2Logs = (Block)Class.forName("net.minecraft.server.RedPowerWorld").getField("blockLogs").get(null);
      rp2Stone = (Block)Class.forName("net.minecraft.server.RedPowerWorld").getField("blockStone").get(null);
      rp2Plants = (Block)Class.forName("net.minecraft.server.RedPowerWorld").getField("blockPlants").get(null);
      rp2Seeds = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSeeds").get(null);
      rp2PickaxeRuby = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemPickaxeRuby").get(null);
      rp2PickaxeSapphire = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemPickaxeSapphire").get(null);
      rp2PickaxeEmerald = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemPickaxeEmerald").get(null);
      rp2ShovelRuby = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemShovelRuby").get(null);
      rp2ShovelSapphire = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemShovelSapphire").get(null);
      rp2ShovelEmerald = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemShovelEmerald").get(null);
      rp2AxeRuby = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemAxeRuby").get(null);
      rp2AxeSapphire = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemAxeSapphire").get(null);
      rp2AxeEmerald = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemAxeEmerald").get(null);
      rp2SwordRuby = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSwordRuby").get(null);
      rp2SwordSapphire = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSwordSapphire").get(null);
      rp2SwordEmerald = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSwordEmerald").get(null);
      rp2HoeRuby = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemHoeRuby").get(null);
      rp2HoeSapphire = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemHoeSapphire").get(null);
      rp2HoeEmerald = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemHoeEmerald").get(null);
      rp2SickleWood = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSickleWood").get(null);
      rp2SickleStone = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSickleStone").get(null);
      rp2SickleIron = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSickleIron").get(null);
      rp2SickleGold = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSickleGold").get(null);
      rp2SickleDiamond = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSickleDiamond").get(null);
      rp2SickleRuby = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSickleRuby").get(null);
      rp2SickleEmerald = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSickleEmerald").get(null);
      rp2SickleSapphire = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemSickleSapphire").get(null);
      rp2HandsawSapphire = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemHandsawSapphire").get(null);
      rp2HandsawRuby = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemHandsawRuby").get(null);
      rp2HandsawEmerald = (Item)Class.forName("net.minecraft.server.RedPowerWorld").getField("itemHandsawEmerald").get(null);
      ...
      net.minecraft.server.ModLoader.getLogger().fine("[EE2] Loaded EE2-RP2 World Addon");
    }
    catch (Exception var1)
    {
      rp2WorldIsInstalled = false;
      net.minecraft.server.ModLoader.getLogger().warning("[EE2] Could not load EE2-RP2 World Addon");
      var1.printStackTrace(System.err);
    }
  }
  
  public static net.minecraft.server.ItemStack getRepairable(Item var0)
  {
    return var0 == null ? null : new net.minecraft.server.ItemStack(var0, 1, -1);
  }
}
