...
public class TileRelay3 extends TileEE implements ISpecialInventory, forge.ISidedInventory, IEEPowerNet
{
  private ItemStack[] items = new ItemStack[22];
  ...
  {
    return var1 == 3 ? EEBase.relayFront : var1 == 1 ? EEBase.relay3Top : EEBase.relaySide;
  }
