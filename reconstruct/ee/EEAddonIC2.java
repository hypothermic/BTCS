...
public class EEAddonIC2
{
  public static void initialize()
  {
    try
    {
      ...
      net.minecraft.server.ModLoader.getLogger().fine("[EE2] Loaded EE2-IC2 Addon");
    }
    catch (Exception var1)
    {
      net.minecraft.server.ModLoader.getLogger().warning("[EE2] Could not load EE2-IC2 Addon");
