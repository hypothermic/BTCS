...
public class TileCollector2 extends TileEE implements buildcraft.api.ISpecialInventory, forge.ISidedInventory, IEEPowerNet
{
  ...
  {
    entityhuman.openGui(net.minecraft.server.mod_EE.getInstance(), ee.core.GuiIds.COLLECTOR_2, this.world, this.x, this.y, this.z);
    return true;
  }
