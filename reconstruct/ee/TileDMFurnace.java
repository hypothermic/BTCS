...
public class TileDMFurnace extends TileEE implements ISpecialInventory, forge.ISidedInventory, IEEPowerNet
{
  ...
  public void q_()
  {
    if (!clientFail())
    {
      ...
      if (!this.world.isStatic)
      {
        ...
        {
          this.currentItemBurnTime = (this.furnaceBurnTime = getItemBurnTime(this.items[0]) / 16);
  ...
  private boolean canSmelt()
  {
    ...
    {
      if (tryDropInChest(this.items[10].cloneItemStack()))
      {
        this.items[10] = null;
        return true;
      }
    ...
    if ((this.items[10].count < getMaxStackSize()) && (this.items[10].count < this.items[10].getMaxStackSize()))
    {
      return true;
    }
  ...
  public void smeltItem()
  {
    if (canSmelt())
    {
      ...
      {
        this.items[10].count += var1.count;
  ...
  public int getItemBurnTime(ItemStack var1)
  {
    ...
    return var2 == EEItem.aeternalisFuel.id ? 409600 : var2 == EEItem.mobiusFuel.id ? 102400 : var2 == EEItem.alchemicalCoal.id ? 25600 : var2 == Block.SAPLING.id ? 100 : var2 == Item.LAVA_BUCKET.id ? 3200 : var2 == Item.COAL.id ? 6400 : var2 == Item.STICK.id ? 100 : (var2 < 256) && (Block.byId[var2].material == Material.WOOD) ? 300 : ModLoader.addAllFuel(var2, var3);
  }
  ...
  {
    return var1 == 1 ? 1 : var1 == 0 ? 0 : 10;
  }
  
  public int getSizeInventorySide(int var1)
  {
    return var1 == 1 ? 9 : var1 == 0 ? 1 : 9;
  }
