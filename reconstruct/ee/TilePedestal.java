...
public class TilePedestal extends TileEE implements net.minecraft.server.IInventory
{
      ...
      if (this.activated)
      {
        ...
        if (this.world.random.nextInt(5) == 0)
        {
          for (int var1 = 0; var1 < 1; var1++)
          {
            ...
            {
              double var6 = this.z + 0.5D + 0.25D * var14;
            ...
            if (this.world.random.nextInt(2) == 0)
            {
              double var2 = this.x + 0.5D + 0.25D * var14;
  ...
  private void doInterdiction(int var1, int var2, int var3)
  {
    ...
    if (this.activated)
    {
      ...
      List var12 = this.world.a(net.minecraft.server.EntityArrow.class, AxisAlignedBB.b(var1 - var4, var2 - var4, var3 - var4, var1 + var4, var2 + var4, var3 + var4));
      ...
      List var13 = this.world.a(net.minecraft.server.EntityFireball.class, AxisAlignedBB.b(var1 - var4, var2 - var4, var3 - var4, var1 + var4, var2 + var4, var3 + var4));
  ...
  {
    var1.openGui(net.minecraft.server.mod_EE.getInstance(), ee.core.GuiIds.PEDESTAL, var1.world, (int)var1.locX, (int)var1.locY, (int)var1.locZ);
    return true;
  }
  ...
  public net.minecraft.server.Packet d()
  {
    EEPacket var1 = ee.network.PacketHandler.getPacket(ee.network.PacketTypeHandler.PEDESTAL);
    ...
    return ee.network.PacketHandler.getPacketForSending(var1);
  }
