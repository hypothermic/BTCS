...
public class ContainerCollector2 extends Container
{
  ...
  public ContainerCollector2(PlayerInventory var1, TileCollector2 var2)
  {
    ...
    a(new Slot(var2, 13, 140, 13));
    a(new Slot(var2, 14, 169, 36));
    
    for (var3 = 0; var3 < 3; var3++)
    {
      for (var4 = 0; var4 < 9; var4++)
      {
        a(new Slot(var1, var4 + var3 * 9 + 9, 20 + var4 * 18, 84 + var3 * 18));
      }
    }
    
    for (var3 = 0; var3 < 9; var3++)
    {
      a(new Slot(var1, var3, 20 + var3 * 18, 142));
    }
  }
  ...
  public ItemStack a(int var1)
  {
    ...
    if ((var3 != null) && (var3.c()))
    {
      ...
      else if ((var1 >= 42) && (var1 <= 50))
      {
        if ((EEMaps.isFuel(var4)) && (!a(var4, 0, 12, true)))
        {
          if (var4.count == 0)
          {
            var3.set(null);
