...
public class BlockEEStone extends BlockContainer implements forge.ITextureProvider, ISpecialResistance
{
  ...
  public int getLightValue(IBlockAccess var1, int var2, int var3, int var4)
  {
    ...
    return var5 == null ? 0 : lightEmission[this.id] > 0 ? lightEmission[this.id] : var5.getLightValue();
  }
  ...
  public void postBreak(World var1, int var2, int var3, int var4, int var5)
  {
    ...
    else
    {
      ...
      a(var1, var2, var3, var4, new ItemStack(EEBlock.eeStone.id, 1, var5));
    }
  }
  ...
  {
    return getHardness(var1.getData(var2, var3, var4));
  }
}
