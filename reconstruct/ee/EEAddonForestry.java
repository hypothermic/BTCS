...
public class EEAddonForestry
{
  ...
  public static void initialize()
  {
    try
    {
      ...
      net.minecraft.server.ModLoader.getLogger().fine("[EE2] Loaded EE2-Forestry Addon");
    }
    catch (Exception var1)
    {
      net.minecraft.server.ModLoader.getLogger().warning("[EE2] Could not load EE2-Forestry Addon");
